GPU_ID=$1
ANN_DIR=/home/tmp_user/code/output/ns-vqa_output/v16_test_prp_refine/config
TRACK_DIR=/home/tmp_user/code/output/ns-vqa_output/v16_test_prp_refine/tracks
...
CUDA_VISIBLE_DEVICES=${GPU_ID} python test_dec_clevrer_v3_prp.py \
    ...
    --vis_dir /home/tmp_user/code/output/visualization/v16_test_prp_dynamics_vis3 \
